...
```json
{
  "buildType" : "maven",
  "gitBranch" : "main",
  "gitUrl" : "https://github.com/eoghank/java-functions-accelerator.git",
  "includeTap" : true,
  "interfaceType" : "http",
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [https://github.com/sample-accelerators/java-functions-accelerator.git->https://github.com/e...(truncated), main->main, my-java-fn->java-function]
